...
count = $(".overF_hidden a").size();   
t = setInterval("banner_run()",timeInterval);   
function switch_banner()
{
    $('.overF_hidden').children().eq(curr).ready(function(){
        //$(".overF_hidden a").filter(":visible").fadeOut(800).parent().children().eq(curr).fadeIn(900); 
        $(".overF_hidden a").filter(":visible").hide().parent().children().eq(curr).show(); 
    });
}
function banner_run()   
{   
...
$('.overF_hidden').mouseover(function()
{
    clearInterval(t);
})
$('.overF_hidden').mouseout(function()
{
    t = setInterval("banner_run()",timeInterval);    
})
...
/*
var goodlandlordImage = $('#goodlandlordImage');
var baojieImage = $('#baojieImage');
var imageSwitch = 0;
setInterval(function(){
    if(imageSwitch)
    {
        goodlandlordImage.animate({opacity: 1}, 800);
        baojieImage.animate({opacity: 0}, 800);
    } else {
        goodlandlordImage.animate({opacity: 0}, 800);
        baojieImage.animate({opacity: 1}, 800);
    }
},3500);
*/

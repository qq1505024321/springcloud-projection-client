...
var jciUrl = "https://jci.xiaozhustatic2.com";
...
try{
    ...
    calendarV2.prototype.genMonth = function() {
        ...
        var spiderAvoidToken = 'spider_avoid_token_calendar';
        if(calendarDay.m <= 7) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(dataObj['error'] == '1')
            {
                ...
                if(partner == 'lotour'){
                    $('body').empty();
                    var lotour='<div class="co_lt_main"><img src="/images/pic_tz.jpg" width="399" height="105" /></div>';
                    $('body').html(lotour);
                    setTimeout(function(){
...
window.DetailMap = {
    config : {'公交站':{def:'icon_bus.png',act:'icon_bus_cur.png',word:'bus_station',num:5},'餐饮':{def:'icon_eat.png',act:'icon_eat_cur.png',word:'restaurant',num:7},'地铁':{def:'icon_subway.png',act:'icon_subway_cur.png',word:'subway_station',num:2},'超市':{def:'icon_store.png',act:'icon_store_cur.png',word:'grocery_or_supermarket',num:3},'便利店':{def:'icon_store.png',act:'icon_store_cur.png',word:'convenience_store',num:2}},
    init : function(){
        //{{{
        var that = this;

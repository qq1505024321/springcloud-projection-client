...
var domain = "xianggang.xiaozhu.com";
...
hotcitys[0]=new Array('bj','北京','beijing','bj','21302','beijing','北京','','',12,0);

hotcitys[1]=new Array('sh','上海','shanghai','sh','19559','shanghai','上海','','',13,0);

hotcitys[3]=new Array('gz','广州','guangzhou','gz','12721','guangdong','广东','','',16,0);

hotcitys[2]=new Array('cd','成都','chengdu','cd','20173','sichuan','四川','','',45,0);

hotcitys[4]=new Array('sz','深圳','shenzhen','sz','9174','guangdong','广东','','',17,0);

hotcitys[8]=new Array('xa','西安','xian','xa','15143','shanxi','陕西','','',176,0);

hotcitys[15]=new Array('nj','南京','nanjing','nj','7279','jiangsu','江苏','','',65,0);

hotcitys[9]=new Array('hz','杭州','hangzhou','hz','9935','zhejiang','浙江','','',26,0);

hotcitys[7]=new Array('cq','重庆','chongqing','cq','16090','chongqing','重庆','','',15,0);

hotcitys[12]=new Array('wh','武汉','wuhan','wh','9875','hubei','湖北','','',194,0);

hotcitys[16]=new Array('sz','苏州','suzhou','su','6656','jiangsu','江苏','','',67,0);

hotcitys[18]=new Array('qd','青岛','qingdao','qd','13077','shandong','山东','','',114,0);

hotcitys[11]=new Array('xm','厦门','xiamen','xm','7071','fujian','福建','','',76,0);

hotcitys[6]=new Array('sy','三亚','sanya','sanya','7871','hainan','海南','','',144,0);

hotcitys[10]=new Array('heb','哈尔滨','haerbin','hrb','4661','heilongjiang','黑龙江','','',93,0);

hotcitys[14]=new Array('tj','天津','tianjin','tj','4285','tianjin','天津','','',14,0);

hotcitys[17]=new Array('km','昆明','kunming','km','4510','yunnan','云南','','',225,0);

hotcitys[5]=new Array('xg','香港','xianggang','hongkong','2485','xianggang','香港','','',344,0);

hotcitys[13]=new Array('cs','长沙','changsha','cs','6415','hunan','湖南','','',204,0);
...
citys[0]=new Array('bj','北京','beijing','bj','21302','beijing','北京','','',12,0);

citys[1]=new Array('sh','上海','shanghai','sh','19559','shanghai','上海','','',13,0);

citys[2]=new Array('gz','广州','guangzhou','gz','12721','guangdong','广东','','',16,0);

citys[3]=new Array('cd','成都','chengdu','cd','20173','sichuan','四川','','',45,0);

citys[4]=new Array('sz','深圳','shenzhen','sz','9174','guangdong','广东','','',17,0);

citys[5]=new Array('xa','西安','xian','xa','15143','shanxi','陕西','','',176,0);

citys[6]=new Array('nj','南京','nanjing','nj','7279','jiangsu','江苏','','',65,0);

citys[7]=new Array('hz','杭州','hangzhou','hz','9935','zhejiang','浙江','','',26,0);

citys[8]=new Array('cq','重庆','chongqing','cq','16090','chongqing','重庆','','',15,0);

citys[9]=new Array('wh','武汉','wuhan','wh','9875','hubei','湖北','','',194,0);

citys[10]=new Array('sz','苏州','suzhou','su','6656','jiangsu','江苏','','',67,0);

citys[11]=new Array('wx','无锡','wuxi','wx','2235','jiangsu','江苏','','',66,0);

citys[12]=new Array('qd','青岛','qingdao','qd','13077','shandong','山东','','',114,0);

citys[13]=new Array('xm','厦门','xiamen','xm','7071','fujian','福建','','',76,0);

citys[14]=new Array('sy','三亚','sanya','sanya','7871','hainan','海南','','',144,0);

citys[15]=new Array('dl','大连','dalian','dl','4960','liaoning','辽宁','','',56,0);

citys[16]=new Array('heb','哈尔滨','haerbin','hrb','4661','heilongjiang','黑龙江','','',93,0);

citys[17]=new Array('qhd','秦皇岛','qinhuangdao','qinhuangdao','7352','hebei','河北','','',3,0);

citys[18]=new Array('tj','天津','tianjin','tj','4285','tianjin','天津','','',14,0);

citys[19]=new Array('km','昆明','kunming','km','4510','yunnan','云南','','',225,0);

citys[20]=new Array('xg','香港','xianggang','hongkong','2485','xianggang','香港','','',344,0);

citys[21]=new Array('cc','长春','changchun','cc','1892','jilin','吉林','','',84,0);

citys[22]=new Array('sy','沈阳','shenyang','sy','3712','liaoning','辽宁','','',55,0);

citys[23]=new Array('hf','合肥','hefei','hf','1870','anhui','安徽','','',123,0);

citys[24]=new Array('zz','郑州','zhengzhou','zz','3020','henan','河南','','',103,0);

citys[25]=new Array('ty','太原','taiyuan','ty','1917','shanxi','山西','','',155,0);

citys[26]=new Array('wh','威海','weihai','wei','4417','shandong','山东','','',120,0);

citys[27]=new Array('lj','丽江','lijiang','lijiang','3402','yunnan','云南','','',230,0);

citys[28]=new Array('dl','大理','dali','dali','5768','yunnan','云南','','',237,0);

citys[29]=new Array('gl','桂林','guilin','gl','3184','guangxi','广西','','',134,0);

citys[30]=new Array('am','澳门','aomen','macao','466','aomen','澳门','','',345,0);

citys[31]=new Array('fz','福州','fuzhou','fz','2273','fujian','福建','','',75,0);

citys[32]=new Array('nb','宁波','ningbo','nb','2516','zhejiang','浙江','','',27,0);

citys[33]=new Array('zh','珠海','zhuhai','zhuhai','1944','guangdong','广东','','',18,0);

citys[34]=new Array('cs','长沙','changsha','cs','6415','hunan','湖南','','',204,0);

citys[35]=new Array('sjz','石家庄','shijiazhuang','sjz','2126','hebei','河北','','',1,0);

citys[36]=new Array('ls','拉萨','lasa','ls','366','xicang','西藏','','',256,0);

citys[37]=new Array('cz','常州','changzhou','changzhou','958','jiangsu','江苏','','',69,0);

citys[38]=new Array('yz','扬州','yangzhou','yangzhou','1458','jiangsu','江苏','','',74,0);

citys[39]=new Array('dg','东莞','dongguan','dg','783','guangdong','广东','','',24,0);

citys[40]=new Array('hk','海口','haikou','hn','2216','hainan','海南','','',143,0);

citys[41]=new Array('lz','兰州','lanzhou','lz','1537','gansu','甘肃','','',166,0);

citys[42]=new Array('ly','洛阳','luoyang','luoyang','1577','henan','河南','','',104,0);

citys[43]=new Array('wlmq','乌鲁木齐','wulumuqi','xj','228','xinjiang','新疆','','',241,0);

citys[44]=new Array('xz','徐州','xuzhou','xuzhou','756','jiangsu','江苏','','',68,0);

citys[45]=new Array('gy','贵阳','guiyang','gy','2469','guizhou','贵州','','',36,0);

citys[46]=new Array('hhht','呼和浩特','huhehaote','nmg','845','neimenggu','内蒙古','','',145,0);

citys[47]=new Array('jn','济南','jinan','jn','2307','shandong','山东','','',113,0);

citys[48]=new Array('ts','唐山','tangshan','tangshan','1146','hebei','河北','','',2,0);

citys[49]=new Array('bd','保定','baoding','baoding','1130','hebei','河北','','',6,0);

citys[50]=new Array('nc','南昌','nanchang','nc','1701','jiangxi','江西','','',214,0);

citys[51]=new Array('hd','邯郸','handan','handan','350','hebei','河北','','',4,0);

citys[52]=new Array('nn','南宁','nanning','nn','2093','guangxi','广西','','',142,0);

citys[53]=new Array('wf','潍坊','weifang','weifang','604','shandong','山东','','',119,0);

citys[54]=new Array('jz','锦州','jinzhou','jinzhou','449','liaoning','辽宁','','',60,0);

citys[55]=new Array('rz','日照','rizhao','rizhao','2256','shandong','山东','','',306,0);

citys[56]=new Array('ly','临沂','linyi','linyi','313','shandong','山东','','',307,0);

citys[57]=new Array('as','鞍山','anshan','anshan','161','liaoning','辽宁','','',57,0);

citys[58]=new Array('lf','廊坊','langfang','langfang','1154','hebei','河北','','',10,0);

citys[59]=new Array('dq','大庆','daqing','daqing','297','heilongjiang','黑龙江','','',98,0);

citys[60]=new Array('bh','北海','beihai','beihai','4680','guangxi','广西','','',317,0);

citys[61]=new Array('zs','中山','zhongshan','zhongshan','500','guangdong','广东','','',25,0);

citys[62]=new Array('xn','西宁','xining','xn','1307','qinghai','青海','','',186,0);

citys[63]=new Array('jh','金华','jinhua','jinhua','874','zhejiang','浙江','','',32,0);

citys[64]=new Array('dd','丹东','dandong','dandong','1276','liaoning','辽宁','','',59,0);

citys[65]=new Array('cd','承德','chengde','chengde','2900','hebei','河北','','',8,0);

citys[66]=new Array('pj','盘锦','panjin','panjin','410','liaoning','辽宁','','',63,0);

citys[67]=new Array('zb','淄博','zibo','zibo','354','shandong','山东','','',115,0);

citys[68]=new Array('zz','株洲','zhuzhou','zhuzhou','314','hunan','湖南','','',205,0);

citys[69]=new Array('fs','佛山','foshan','foshan','1528','guangdong','广东','','',20,0);

citys[70]=new Array('jl','吉林','jilinshi','jilin','556','jilin','吉林','','',85,0);

citys[71]=new Array('yl','玉林','yulin','gxyulin','29','guangxi','广西','','',138,0);

citys[72]=new Array('xt','邢台','xingtai','xingtai','245','hebei','河北','','',5,0);

citys[73]=new Array('qqhe','齐齐哈尔','qiqihaer','qiqihaer','214','heilongjiang','黑龙江','','',94,0);

citys[74]=new Array('yc','宜昌','yichang','yichang','827','hubei','湖北','','',199,0);

citys[75]=new Array('dt','大同','datong','datong','844','shanxi','山西','','',156,0);

citys[76]=new Array('yt','烟台','yantai','yantai','4628','shandong','山东','','',118,0);

citys[77]=new Array('yc','银川','yinchuan','yc','473','ningxia','宁夏','','',165,0);

citys[78]=new Array('wz','温州','wenzhou','wenzhou','1246','zhejiang','浙江','','',28,0);

citys[79]=new Array('ha','淮安','huaian','huaian','177','jiangsu','江苏','','',72,0);

citys[80]=new Array('my','绵阳','mianyang','mianyang','537','sichuan','四川','','',49,0);

citys[81]=new Array('bt','包头','baotou','baotou','341','neimenggu','内蒙古','','',146,0);

citys[82]=new Array('fs','抚顺','fushun','fushun','133','liaoning','辽宁','','',58,0);

citys[83]=new Array('ta','泰安','taian','taian','735','shandong','山东','','',305,0);

citys[84]=new Array('jn','济宁','jining','jining','371','shandong','山东','','',304,0);

citys[85]=new Array('lyg','连云港','lianyungang','lianyungang','582','jiangsu','江苏','','',71,0);

citys[86]=new Array('hnz','海南州','hainan','hainanzhou','57','qinghai','青海','','',190,0);

citys[87]=new Array('qz','泉州','quanzhou','quanzhou','1104','fujian','福建','','',79,0);

citys[88]=new Array('ay','安阳','anyang','anyang','175','henan','河南','','',109,0);

citys[89]=new Array('hz','惠州','huizhou','huizhou','7011','guangdong','广东','','',23,0);

citys[90]=new Array('hld','葫芦岛','huludao','huludao','3858','liaoning','辽宁','','',64,0);

citys[91]=new Array('jx','嘉兴','jiaxing','jiaxing','2695','zhejiang','浙江','','',29,0);

citys[92]=new Array('nt','南通','nantong','nantong','745','jiangsu','江苏','','',70,0);

citys[93]=new Array('pzh','攀枝花','panzhihua','panzhihua','198','sichuan','四川','','',274,0);

citys[94]=new Array('lz','柳州','liuzhou','liuzhou','362','guangxi','广西','','',133,0);

citys[95]=new Array('dy','东营','dongying','dongying','32','shandong','山东','','',117,0);

citys[96]=new Array('jms','佳木斯','jiamusi','jiamusi','202','heilongjiang','黑龙江','','',100,0);

citys[97]=new Array('tl','通辽','tongliao','tongliao','64','neimenggu','内蒙古','','',149,0);

citys[98]=new Array('dz','德州','dezhou','dezhou','325','shandong','山东','','',308,0);

citys[99]=new Array('gz','赣州','ganzhou','ganzhou','230','jiangxi','江西','','',220,0);

citys[100]=new Array('bz','滨州','binzhou','binzhou','71','shandong','山东','','',122,0);

citys[101]=new Array('xy','咸阳','xianyang','xianyang','420','shanxi','陕西','','',179,0);

citys[102]=new Array('jm','江门','jiangmen','jiangmen','312','guangdong','广东','','',21,0);

citys[103]=new Array('zz','漳州','zhangzhou','zhangzhou','1846','fujian','福建','','',80,0);

citys[104]=new Array('xx','新乡','xinxiang','xinxiang','270','henan','河南','','',108,0);

citys[105]=new Array('xy','襄阳','xiangyang','xiangyang','195','hubei','湖北','','',196,0);

citys[106]=new Array('nc','南充','nanchong','nanchong','422','sichuan','四川','','',51,0);

citys[107]=new Array('lc','聊城','liaocheng','liaocheng','237','shandong','山东','','',309,0);

citys[108]=new Array('zjk','张家口','zhangjiakou','zhangjiakou','1201','hebei','河北','','',7,0);

citys[109]=new Array('cz','沧州','cangzhou','cangzhou','187','hebei','河北','','',9,0);

citys[110]=new Array('shz','石河子','shihezi','shihezi','29','xinjiang','新疆','','',255,0);

citys[111]=new Array('bj','宝鸡','baoji','baoji','116','shanxi','陕西','','',178,0);

citys[112]=new Array('cf','赤峰','chifeng','chifeng','265','neimenggu','内蒙古','','',148,0);

citys[113]=new Array('zj','湛江','zhanjiang','zhanjiang','476','guangdong','广东','','',264,0);

citys[114]=new Array('sq','商丘','shangqiu','shangqiu','139','henan','河南','','',297,0);

citys[115]=new Array('pds','平顶山','pingdingshan','pingdingshan','54','henan','河南','','',105,0);

citys[116]=new Array('xy','信阳','xinyang','xinyang','63','henan','河南','','',298,0);

citys[117]=new Array('jj','九江','jiujiang','jiujiang','476','jiangxi','江西','','',217,0);

citys[118]=new Array('yk','营口','yingkou','yingkou','3029','liaoning','辽宁','','',61,0);

citys[119]=new Array('bx','本溪','benxi','benxi','342','liaoning','辽宁','','',286,0);

citys[120]=new Array('ly','辽阳','liaoyang','liaoyang','17','liaoning','辽宁','','',62,0);

citys[121]=new Array('qz','钦州','qinzhou','qinzhou','19','guangxi','广西','','',136,0);

citys[122]=new Array('hy','衡阳','hengyang','hengyang','466','hunan','湖南','','',207,0);

citys[123]=new Array('st','汕头','shantou','shantou','1010','guangdong','广东','','',19,0);

citys[124]=new Array('wh','芜湖','wuhu','wuhu','352','anhui','安徽','','',124,0);

citys[125]=new Array('hlbe','呼伦贝尔','hulunbeier','hulunbeier','830','neimenggu','内蒙古','','',151,0);

citys[126]=new Array('xt','湘潭','xiangtan','xiangtan','151','hunan','湖南','','',206,0);

citys[127]=new Array('cys','朝阳市','chaoyang','chaoyang','34','liaoning','辽宁','','',289,0);

citys[128]=new Array('qy','清远','qingyuan','qingyuan','1662','guangdong','广东','','',270,0);

citys[129]=new Array('sn','遂宁','suining','suining','78','sichuan','四川','','',276,0);

citys[130]=new Array('tz','泰州','taizhoujs','jstaizhou','112','jiangsu','江苏','','',291,0);

citys[131]=new Array('pt','莆田','putian','putian','166','fujian','福建','','',77,0);

citys[132]=new Array('zz','枣庄','zaozhuang','zaozhuang','608','shandong','山东','','',116,0);

citys[133]=new Array('lz','泸州','luzhou','luzhou','207','sichuan','四川','','',47,0);

citys[134]=new Array('zs','舟山','zhoushan','zhoushan','3103','zhejiang','浙江','','',34,0);

citys[135]=new Array('zj','镇江','zhenjiang','zhenjiang','316','jiangsu','江苏','','',290,0);

citys[136]=new Array('kf','开封','kaifeng','kaifeng','978','henan','河南','','',293,0);

citys[137]=new Array('eeds','鄂尔多斯','eerduosi','eerduosi','128','neimenggu','内蒙古','','',150,0);

citys[138]=new Array('sy','十堰','shiyan','shiyan','148','hubei','湖北','','',197,0);

citys[139]=new Array('yb','延边','yanbian','yanbian','828','jilin','吉林','','',92,0);

citys[140]=new Array('hb','淮北','huaibei','huaibei','65','anhui','安徽','','',311,0);

citys[141]=new Array('lf','临汾','linfen','linfen','250','shanxi','山西','','',164,0);

citys[142]=new Array('cd','常德','changde','changde','170','hunan','湖南','','',210,0);

citys[143]=new Array('jz','荆州','jingzhou','jingzhou','165','hubei','湖北','','',198,0);

citys[144]=new Array('cz','郴州','chenzhou','chenzhou','867','hunan','湖南','','',211,0);

citys[145]=new Array('dy','德阳','deyang','deyang','217','sichuan','四川','','',48,0);

citys[146]=new Array('sx','绍兴','shaoxing','shaoxing','602','zhejiang','浙江','','',31,0);

citys[147]=new Array('ny','南阳','nanyang','nanyang','197','henan','河南','','',111,0);

citys[148]=new Array('hz','菏泽','heze','heze','118','shandong','山东','','',338,0);

citys[149]=new Array('tz','台州','taizhouzj','taizhouzj','861','zhejiang','浙江','','',35,0);

citys[150]=new Array('zy','遵义','zunyi','zunyi','348','guizhou','贵州','','',38,0);

citys[151]=new Array('fx','阜新','fuxin','fuxin','27','liaoning','辽宁','','',287,0);

citys[152]=new Array('yc','盐城','yancheng','yancheng','112','jiangsu','江苏','','',73,0);

citys[153]=new Array('xq','宿迁','suqian','suqian','91','jiangsu','江苏','','',292,0);

citys[154]=new Array('jz','焦作','jiaozuo','jiaozuo','157','henan','河南','','',106,0);

citys[155]=new Array('cz','长治','changzhi','changzhi','153','shanxi','山西','','',158,0);

citys[156]=new Array('ja','吉安','jian','jian','208','jiangxi','江西','','',221,0);

citys[157]=new Array('dz','达州','dazhou','dazhou','80','sichuan','四川','','',53,0);

citys[158]=new Array('lh','漯河','luohe','luohe','6','henan','河南','','',110,0);

citys[159]=new Array('zmd','驻马店','zhumadian','zhumadian','56','henan','河南','','',300,0);

citys[160]=new Array('hz','汉中','hanzhong','hanzhong','143','shanxi','陕西','','',182,0);

citys[161]=new Array('hy','河源','heyuan','heyuan','169','guangdong','广东','','',268,0);

citys[162]=new Array('tl','铁岭','tieling','tieling','31','liaoning','辽宁','','',288,0);

citys[163]=new Array('jz','晋中','jinzhong','jinzhong','1258','shanxi','山西','','',161,0);

citys[164]=new Array('ak','安康','ankang','ankang','42','shanxi','陕西','','',184,0);

citys[165]=new Array('xg','孝感','xiaogan','xiaogan','36','hubei','湖北','','',327,0);

citys[166]=new Array('yy','岳阳','yueyang','yueyang','236','hunan','湖南','','',209,0);

citys[167]=new Array('zq','肇庆','zhaoqing','zhaoqing','328','guangdong','广东','','',265,0);

citys[168]=new Array('hs','衡水','hengshui','hengshui','428','hebei','河北','','',11,0);

citys[169]=new Array('mdj','牡丹江','mudanjiang','mudanjiang','253','heilongjiang','黑龙江','','',302,0);

citys[170]=new Array('aq','安庆','anqing','anqing','72','anhui','安徽','','',127,0);

citys[171]=new Array('hg','黄冈','huanggang','huanggang','73','hubei','湖北','','',328,0);

citys[172]=new Array('ld','娄底','loudi','loudi','33','hunan','湖南','','',213,0);

citys[173]=new Array('ls','乐山','leshan','leshan','1735','sichuan','四川','','',50,0);

citys[174]=new Array('sp','四平','siping','siping','152','jilin','吉林','','',86,0);

citys[175]=new Array('bb','蚌埠','bengbu','bengbu','103','anhui','安徽','','',125,0);

citys[176]=new Array('cj','昌吉','changji','changji','5','xinjiang','新疆','','',250,0);

citys[177]=new Array('sg','韶关','shaoguan','shaoguan','333','guangdong','广东','','',263,0);

citys[178]=new Array('yj','阳江','yangjiang','yangjiang','1593','guangdong','广东','','',269,0);

citys[179]=new Array('cz','潮州','chaozhou','chaozhou','390','guangdong','广东','','',271,0);

citys[180]=new Array('zjj','张家界','zhangjiajie','zhangjiajie','1455','hunan','湖南','','',334,0);

citys[181]=new Array('hh','怀化','huaihua','huaihua','74','hunan','湖南','','',336,0);

citys[182]=new Array('xsbn','西双版纳','xishuangbanna','xishuangbanna','1625','yunnan','云南','','',235,0);

citys[183]=new Array('sm','三明','sanming','sanming','79','fujian','福建','','',78,0);
...
citys[186]=new Array('ms','眉山','meishan','meishan','239','sichuan','四川','','',279,0);

citys[187]=new Array('xc','许昌','xuchang','xuchang','48','henan','河南','','',295,0);

citys[188]=new Array('sh','绥化','suihua','suihua','39','heilongjiang','黑龙江','','',102,0);

citys[189]=new Array('fcg','防城港','fangchenggang','fangchenggang','646','guangxi','广西','','',318,0);

citys[190]=new Array('yz','永州','yongzhou','yongzhou','42','hunan','湖南','','',212,0);

citys[191]=new Array('yy','益阳','yiyang','yiyang','17','hunan','湖南','','',335,0);

citys[192]=new Array('sr','上饶','shangrao','shangrao','1032','jiangxi','江西','','',224,0);

citys[193]=new Array('qz','衢州','quzhou','quzhou','156','zhejiang','浙江','','',33,0);

citys[194]=new Array('lps','六盘水','liupanshui','liupanshui','326','guizhou','贵州','','',37,0);

citys[195]=new Array('zk','周口','zhoukou','zhoukou','44','henan','河南','','',299,0);

citys[196]=new Array('bs','白山','baishan','baishan','382','jilin','吉林','','',89,0);

citys[197]=new Array('la','六安','luan','luan','41','anhui','安徽','','',132,0);

citys[198]=new Array('tl','铜陵','tongling','tongling','37','anhui','安徽','','',312,0);

citys[199]=new Array('sz','池州','chizhou','chizhou','235','anhui','安徽','','',315,0);

citys[200]=new Array('jc','晋城','jincheng','jincheng','121','shanxi','山西','','',159,0);

citys[201]=new Array('hs','黄石','huangshi','huangshi','47','hubei','湖北','','',195,0);

citys[202]=new Array('xx','湘西','xiangxi','xiangxi','758','hunan','湖南','','',337,0);

citys[203]=new Array('yc','宜春','yichunjx','jxyichun','155','jiangxi','江西','','',222,0);

citys[204]=new Array('mm','茂名','maoming','maoming','64','guangdong','广东','','',22,0);

citys[205]=new Array('mz','梅州','meizhou','meizhou','120','guangdong','广东','','',266,0);

citys[206]=new Array('ls','凉山','liangshan','liangshan','967','sichuan','四川','','',54,0);

citys[207]=new Array('yb','宜宾','yibin','yibin','193','sichuan','四川','','',52,0);

citys[208]=new Array('hz','湖州','huzhou','huzhou','2848','zhejiang','浙江','','',30,0);

citys[209]=new Array('py','濮阳','puyang','puyang','26','henan','河南','','',294,0);

citys[210]=new Array('cz','滁州','chuzhou','chuzhou','106','anhui','安徽','','',128,0);

citys[211]=new Array('ya','延安','yanan','yanan','286','shanxi','陕西','','',181,0);

citys[212]=new Array('nj','内江','neijiang','neijiang','66','sichuan','四川','','',277,0);

citys[213]=new Array('np','南平','nanping','nanping','520','fujian','福建','','',81,0);

citys[214]=new Array('smx','三门峡','sanmenxia','sanmenxia','46','henan','河南','','',296,0);

citys[215]=new Array('ly','辽源','liaoyuan','liaoyuan','21','jilin','吉林','','',87,0);

citys[216]=new Array('sy','松原','songyuan','songyuan','96','jilin','吉林','','',90,0);

citys[217]=new Array('sys','双鸭山','shuangyashan','shuangyashan','10','heilongjiang','黑龙江','','',97,0);

citys[218]=new Array('fy','阜阳','fuyang','fuyang','68','anhui','安徽','','',129,0);

citys[219]=new Array('hs','黄山','huangshan','huangshan','1871','anhui','安徽','','',313,0);

citys[220]=new Array('byne','巴彦淖尔','bayannaoer','bayannaoer','23','neimenggu','内蒙古','','',152,0);

citys[221]=new Array('wn','渭南','weinan','weinan','228','shanxi','陕西','','',180,0);

citys[222]=new Array('xn','咸宁','xianning','xianning','61','hubei','湖北','','',329,0);

citys[223]=new Array('es','恩施','enshi','enshi','1461','hubei','湖北','','',331,0);

citys[224]=new Array('fz','抚州','fuzhouj','jxfuzhou','49','jiangxi','江西','','',223,0);

citys[225]=new Array('ly','龙岩','longyan','longyan','228','fujian','福建','','',82,0);

citys[226]=new Array('th','通化','tonghua','tonghua','266','jilin','吉林','','',88,0);

citys[227]=new Array('bc','白城','baicheng','baicheng','74','jilin','吉林','','',91,0);

citys[228]=new Array('xc','宣城','xuancheng','xuancheng','307','anhui','安徽','','',316,0);

citys[229]=new Array('xlgl','锡林郭勒','xilinguole','xilinguole','268','neimenggu','内蒙古','','',321,0);

citys[230]=new Array('sy','邵阳','shaoyang','shaoyang','52','hunan','湖南','','',208,0);

citys[231]=new Array('jdz','景德镇','jingdezhen','jingdezhen','499','jiangxi','江西','','',215,0);

citys[232]=new Array('qj','曲靖','qujing','qujing','92','yunnan','云南','','',226,0);
...
citys[236]=new Array('jy','济源','jiyuan','jiyuan','19','henan','河南','','',112,0);

citys[237]=new Array('hg','鹤岗','hegang','hegang','7','heilongjiang','黑龙江','','',96,0);

citys[238]=new Array('hh','黑河','heihe','heihe','153','heilongjiang','黑龙江','','',101,0);

citys[239]=new Array('ll','吕梁','lvliang','lvliang','46','shanxi','山西','','',323,0);

citys[240]=new Array('ts','天水','tianshui','tianshui','93','gansu','甘肃','','',169,0);
...
citys[243]=new Array('hm','哈密','hami','hami','7','xinjiang','新疆','','',244,0);

citys[244]=new Array('yf','云浮','yunfu','yunfu','26','guangdong','广东','','',273,0);

citys[245]=new Array('zg','自贡','zigong','zigong','159','sichuan','四川','','',46,0);

citys[246]=new Array('ab','阿坝','aba','aba','259','sichuan','四川','','',283,0);

citys[247]=new Array('nd','宁德','ningde','ningde','450','fujian','福建','','',83,0);

citys[248]=new Array('mas','马鞍山','maanshan','maanshan','20','anhui','安徽','','',126,0);

citys[249]=new Array('als','阿拉善','alashan','alashan','563','neimenggu','内蒙古','','',322,0);

citys[250]=new Array('yq','阳泉','yangquan','yangquan','21','shanxi','山西','','',157,0);
...
citys[254]=new Array('qxn','黔西南','qianxinan','qianxinan','254','guizhou','贵州','','',42,0);

citys[255]=new Array('jx','鸡西','jixi','jixi','100','heilongjiang','黑龙江','','',95,0);
...
citys[258]=new Array('xz','宿州','suzhouah','ahsuzhou','84','anhui','安徽','','',130,0);

citys[259]=new Array('wz','梧州','wuzhou','wuzhou','84','guangxi','广西','','',135,0);

citys[260]=new Array('gg','贵港','guigang','guigang','13','guangxi','广西','','',137,0);

citys[261]=new Array('sz','朔州','shuozhou','shuozhou','30','shanxi','山西','','',160,0);

citys[262]=new Array('qy','庆阳','qingyang','qingyang','8','gansu','甘肃','','',174,0);

citys[263]=new Array('ez','鄂州','ezhou','ezhou','40','hubei','湖北','','',201,0);

citys[264]=new Array('aks','阿克苏','akesu','akesu','10','xinjiang','新疆','','',246,0);

citys[265]=new Array('sw','汕尾','shanwei','shanwei','335','guangdong','广东','','',267,0);

citys[266]=new Array('ga','广安','guangan','guangan','50','sichuan','四川','','',278,0);

citys[267]=new Array('zy','资阳','ziyang','ziyang','49','sichuan','四川','','',282,0);

citys[268]=new Array('as','安顺','anshun','anshun','194','guizhou','贵州','','',39,0);

citys[269]=new Array('qdn','黔东南','qiandongnan','qiandongnan','792','guizhou','贵州','','',43,0);
...
citys[272]=new Array('wh','乌海','wuhai','wuhai','19','neimenggu','内蒙古','','',147,0);

citys[273]=new Array('zy','张掖','zhangye','zhangye','251','gansu','甘肃','','',171,0);

citys[274]=new Array('jq','酒泉','jiuquan','jiuquan','458','gansu','甘肃','','',173,0);

citys[275]=new Array('ln','陇南','longnan','longnan','21','gansu','甘肃','','',324,0);

citys[276]=new Array('snj','神农架','shennongjia','shennongjia','226','hubei','湖北','','',333,0);

citys[277]=new Array('klmy','克拉玛依','kelamayi','kelamayi','20','xinjiang','新疆','','',242,0);

citys[278]=new Array('yl','伊犁','yili','yili','199','xinjiang','新疆','','',252,0);

citys[279]=new Array('betl','博尔塔拉','boertala','boertala','3','xinjiang','新疆','','',251,0);

citys[280]=new Array('alt','阿勒泰','aletai','aletai','64','xinjiang','新疆','','',254,0);

citys[281]=new Array('ya','雅安','yaan','yaan','283','sichuan','四川','','',280,0);

citys[282]=new Array('gz','甘孜','ganzi','ganzi','556','sichuan','四川','','',284,0);

citys[283]=new Array('ls','丽水','lishui','lishui','808','zhejiang','浙江','','',285,0);

citys[284]=new Array('bz','亳州','bozhou','bozhou','35','anhui','安徽','','',314,0);

citys[285]=new Array('bs','百色','baise','baise','26','guangxi','广西','','',139,0);

citys[286]=new Array('hz','贺州','hezhou','hezhou','139','guangxi','广西','','',319,0);

citys[287]=new Array('wlcb','乌兰察布','wulanchabu','wulanchabu','62','neimenggu','内蒙古','','',153,0);

citys[288]=new Array('szs','石嘴山','shizuishan','shizuishan','1','ningxia','宁夏','','',339,0);

citys[289]=new Array('zw','中卫','zhongwei','zhongwei','129','ningxia','宁夏','','',342,0);

citys[290]=new Array('jc','金昌','jinchang','jinchang','8','gansu','甘肃','','',167,0);

citys[291]=new Array('by','白银','baiyin','baiyin','4','gansu','甘肃','','',168,0);

citys[292]=new Array('pl','平凉','pingliang','pingliang','16','gansu','甘肃','','',172,0);

citys[293]=new Array('dx','定西','dingxi','dingxi','2','gansu','甘肃','','',175,0);

citys[294]=new Array('tc','铜川','tongchuan','tongchuan','7','shanxi','陕西','','',177,0);

citys[295]=new Array('qj','潜江','qianjiang','qianjiang','20','hubei','湖北','','',203,0);

citys[296]=new Array('yt','鹰潭','yingtan','yingtan','32','jiangxi','江西','','',219,0);

citys[297]=new Array('zt','昭通','zhaotong','zhaotong','51','yunnan','云南','','',229,0);
...
citys[300]=new Array('tr','铜仁','tongren','tongren','93','guizhou','贵州','','',40,0);

citys[301]=new Array('lb','来宾','laibin','laibin','15','guangxi','广西','','',141,0);

citys[302]=new Array('cz','崇左','chongzuo','chongzuo','23','guangxi','广西','','',320,0);

citys[303]=new Array('xz','忻州','xinzhou','xinzhou','74','shanxi','山西','','',163,0);

citys[304]=new Array('wz','吴忠','wuzhong','wuzhong','14','ningxia','宁夏','','',340,0);

citys[305]=new Array('gy','固原','guyuan','guyuan','7','ningxia','宁夏','','',341,0);

citys[306]=new Array('ww','武威','wuwei','wuwei','12','gansu','甘肃','','',170,0);

citys[307]=new Array('gn','甘南','gannan','gannan','15','gansu','甘肃','','',326,0);

citys[308]=new Array('hx','海西','haixi','haixi','222','qinghai','青海','','',193,0);

citys[309]=new Array('jm','荆门','jingmen','jingmen','23','hubei','湖北','','',200,0);

citys[310]=new Array('yx','玉溪','yuxi','yuxi','387','yunnan','云南','','',227,0);

citys[311]=new Array('hh','红河','honghe','honghe','383','yunnan','云南','','',234,0);

citys[312]=new Array('dh','德宏','dehong','dehong','36','yunnan','云南','','',238,0);

citys[313]=new Array('tlf','吐鲁番','tulufan','tulufan','12','xinjiang','新疆','','',243,0);

citys[314]=new Array('tc','塔城','tacheng','tacheng','1','xinjiang','新疆','','',253,0);

citys[315]=new Array('qn','黔南','qiannan','qiannan','334','guizhou','贵州','','',44,0);

citys[316]=new Array('hb','鹤壁','hebi','hebi','12','henan','河南','','',107,0);

citys[317]=new Array('wzs','五指山','wuzhishan','wuzhishan','28','hainan','海南','','',353,0);

citys[318]=new Array('xa','兴安','xingan','xingan','182','neimenggu','内蒙古','','',154,0);

citys[319]=new Array('jyg','嘉峪关','jiayuguan','jiayuguan','150','gansu','甘肃','','',343,0);

citys[320]=new Array('lx','临夏','linxia','linxia','13','gansu','甘肃','','',325,0);

citys[321]=new Array('sl','商洛','shangluo','shangluo','25','shanxi','陕西','','',185,0);

citys[322]=new Array('hd','海东','haidong','haidong','76','qinghai','青海','','',187,0);

citys[323]=new Array('hb','海北','haibei','haibei','193','qinghai','青海','','',188,0);

citys[324]=new Array('xt','仙桃','xiantao','xiantao','1','hubei','湖北','','',202,0);

citys[325]=new Array('sz','随州','suizhou','suizhou','11','hubei','湖北','','',330,0);

citys[326]=new Array('bs','保山','baoshan','baoshan','471','yunnan','云南','','',228,0);
...
citys[330]=new Array('ws','文山','wenshan','wenshan','154','yunnan','云南','','',233,0);

citys[331]=new Array('nj','怒江','nujiang','nujiang','2','yunnan','云南','','',239,0);

citys[332]=new Array('dq','迪庆','diqing','diqing','165','yunnan','云南','','',240,0);
...
citys[335]=new Array('wjq','五家渠','wujiaqu','wujiaqu','3','xinjiang','新疆','','',376,0);

citys[336]=new Array('wc','文昌','wenchang','wc','310','hainan','海南','','',397,0);

citys[337]=new Array('qh','琼海','qionghai','qionghai','422','hainan','海南','','',399,0);

citys[338]=new Array('dz','儋州','danzhou','danzhou','224','hainan','海南','','',400,0);

citys[339]=new Array('wn','万宁','wanning','wanning','431','hainan','海南','','',401,0);

citys[340]=new Array('df','东方','dongfang','dongfang','54','hainan','海南','','',402,0);

citys[341]=new Array('da','定安','dingan','dingan','18','hainan','海南','','',403,0);

citys[342]=new Array('tc','屯昌','tunchang','tunchang','3','hainan','海南','','',404,0);

citys[343]=new Array('cm','澄迈','chengmai','chengmai','171','hainan','海南','','',405,0);

citys[344]=new Array('lg','临高','lingao','lingao','27','hainan','海南','','',406,0);

citys[345]=new Array('bs','白沙','baisha','baisha','2','hainan','海南','','',407,0);

citys[346]=new Array('cj','昌江','changjiang','changjiang','27','hainan','海南','','',408,0);

citys[347]=new Array('ld','乐东','ledong','ledong','44','hainan','海南','','',409,0);

citys[348]=new Array('ls','陵水','lingshui','lingshui','537','hainan','海南','','',410,0);

citys[349]=new Array('bt','保亭','baoting','baoting','21','hainan','海南','','',411,0);

citys[350]=new Array('qz','琼中','qiongzhong','qiongzhong','13','hainan','海南','','',412,0);

citys[351]=new Array('ylx','宜兰县','yilanxian','ylxian','8','taiwan','台湾','','',393,0);

citys[352]=new Array('tb','台北','taibei','taipei','983','taiwan','台湾','','',378,0);

citys[353]=new Array('xb','新北','xinbei','newnorth','15','taiwan','台湾','','',379,0);

citys[354]=new Array('tz','台中','taizhong','taichung','371','taiwan','台湾','','',380,0);

citys[355]=new Array('tn','台南','tainan','tainan','403','taiwan','台湾','','',381,0);

citys[356]=new Array('gx','高雄','gaoxiong','kaohsiung','470','taiwan','台湾','','',382,0);

citys[357]=new Array('xz','新竹','xinzhu','hsinchu','2','taiwan','台湾','','',384,0);

citys[358]=new Array('jy','嘉义','jiayi','chiayi','240','taiwan','台湾','','',385,0);

citys[359]=new Array('tys','桃园市','taoyuanshi','taoyuan','1','taiwan','台湾','','',386,0);

citys[360]=new Array('ntx','南投县','nantouxian','ntx','536','taiwan','台湾','','',390,0);

citys[361]=new Array('hlx','花莲县','hualianxian','hlx','799','taiwan','台湾','','',394,0);

citys[362]=new Array('tdx','台东县','taidongxian','tdx','1','taiwan','台湾','','',395,0);

citys[363]=new Array('phx','澎湖县','penghuxian','phx','3','taiwan','台湾','','',396,0);

citys[364]=new Array('pdx','屏东县','pingdongxian','pingtungcounty','663','taiwan','台湾','','',2764,0);

var abroadcitys=new Array();

abroadcitys[0]=new Array('cy','长野','changye','nagano','3','changye','长野','','',2836,1,'+9:00');

abroadcitys[1]=new Array('qs','青森','qingsen','aomorishi','1','qingsen','青森','','',2838,1,'+9:00');

abroadcitys[2]=new Array('yazhuang','芽庄','yazhuang','yazhuang','59','qinghe','庆和','','',2840,1,'+07:00');

abroadcitys[3]=new Array('hjha','黄金海岸','huangjinhaian','goldcoast','12','','昆士兰','','',532,1,'+10:00');

abroadcitys[4]=new Array('dld','多伦多','duolunduo','toronto','37','','安大略省','','',712,1,'-06:00');
...
abroadcitys[9]=new Array('yd','雅典','yadian','athens','37','','阿提卡大区','','',1019,1,'+02:00');
...
abroadcitys[12]=new Array('flls','佛罗伦萨','foluolunsa','florence','5','','托斯卡纳','','',1174,1,'+01:00');

abroadcitys[13]=new Array('lm','罗马','luoma','rome','21','','拉齐奥','','',1181,1,'+01:00');

abroadcitys[14]=new Array('mgw','名古屋','mingguwu','nagoya','532','aizhi','爱知','','',1193,1,'+09:00');

abroadcitys[15]=new Array('zh','札幌','zhahuang','sapporo','545','beihaidao','北海道','','',1194,1,'+09:00');

abroadcitys[16]=new Array('fg','福冈','fugang','fukuoka','147','fugang','福冈','','',1197,1,'+09:00');

abroadcitys[17]=new Array('ml','马累','malei','male','1','','马累','','',1620,1,'+05:00');

abroadcitys[18]=new Array('msk','莫斯科','mosike','moscow','24','','中央','','',1897,1,'+03:00');

abroadcitys[19]=new Array('sbdb','圣彼得堡','shengbidebao','saintpetersburg','9','','西北','','',1914,1,'+03:00');

abroadcitys[20]=new Array('bsln','巴塞罗那','basailuona','barcelona','46','','巴塞罗那','','',2049,1,'+01:00');

abroadcitys[21]=new Array('mdl','马德里','madeli','madrid','51','','马德里','','',2060,1,'+01:00');

abroadcitys[22]=new Array('adb','爱丁堡','aidingbao','edinburgh','5','','苏格兰','','',2210,1,'+00:00');

abroadcitys[23]=new Array('ld','伦敦','lundun','london','45','','英格兰','','',2242,1,'+00:00');

abroadcitys[24]=new Array('hsd','华盛顿','huashengdun','washington','2','','哥伦比亚特区','','',2350,1,'-05:00');

abroadcitys[25]=new Array('xyt','西雅图','xiyatu','seattle','7','','华盛顿','','',2353,1,'-08:00');

abroadcitys[26]=new Array('jjs','旧金山','jiujinshan','sanfrancisco','66','','加利福尼亚','','',2360,1,'-08:00');

abroadcitys[27]=new Array('bsd','波士顿','boshidun','boston','5','','马萨诸塞','','',2406,1,'-05:00');

abroadcitys[28]=new Array('lswjs','拉斯维加斯','lasiweijiasi','lasvegas','48','','内华达','','',2460,1,'-07:00');

abroadcitys[29]=new Array('ny','纽约','niuyue','newyork','54','','纽约','','',2465,1,'-05:00');

abroadcitys[30]=new Array('zjg','芝加哥','zhijiage','chicago','15','','伊利诺斯','','',2534,1,'-06:00');

abroadcitys[31]=new Array('alw','埃里温','ailiwen','yerwin','1','','埃里温市','','',517,1,'+05:00');

abroadcitys[32]=new Array('blsb','布里斯班','bulisiban','brisbane','30','','昆士兰','','',531,1,'+10:00');

abroadcitys[33]=new Array('kes','凯恩斯','kaiensi','keynes','5','','昆士兰','','',533,1,'+10:00');

abroadcitys[34]=new Array('hbt','霍巴特','huobate','hobart','15','','塔斯马尼亚','','',547,1,'+10:00');

abroadcitys[35]=new Array('lssd','朗塞斯顿','langsaisidun','lausington','6','','塔斯马尼亚','','',548,1,'+10:00');

abroadcitys[36]=new Array('ps','珀斯','bosi','perth','2','','西澳大利亚','','',557,1,'+08:00');

abroadcitys[37]=new Array('nkse','纽卡斯尔','niukasier','niukasier','1','','新南威尔士','','',558,1,'+10:00');

abroadcitys[38]=new Array('wyn','维也纳','weiyena','vienna','23','','维也纳','','',569,1,'+01:00');

abroadcitys[39]=new Array('blse','布鲁塞尔','bulusaier','brussels','2','','布鲁塞尔首都大区','','',599,1,'+01:00');

abroadcitys[40]=new Array('sbl','圣保罗','shengbaoluo','stpaul','1','','东南地区','','',660,1,'-03:00');

abroadcitys[41]=new Array('wl','文莱','wenlai','brunei','3','','文莱','','',664,1,'+08:00');

abroadcitys[42]=new Array('sfy','索非亚','suofeiya','sofia','1','','索非亚市','','',665,1,'+02:00');

abroadcitys[43]=new Array('fldld','弗雷德里顿','fuleidelidun','fredericton','1','','新不伦瑞克省','','',710,1,'-04:00');

abroadcitys[44]=new Array('wnb','温尼伯','wennibo','winnipeg','4','','马尼托巴省','','',713,1,'-06:00');

abroadcitys[45]=new Array('ylnf','耶洛奈夫','yeluonaifu','yellowknife','1','','西北地区','','',717,1,'-07:00');

abroadcitys[46]=new Array('blg','布拉格','bulage','prague','13','bulage','布拉格','','',775,1,'+01:00');

abroadcitys[47]=new Array('gbhg','哥本哈根','gebenhagen','copenhagen','2','','京畿','','',785,1,'+01:00');

abroadcitys[48]=new Array('kl','开罗','kailuo','cairo','2','','开罗','','',823,1,'+02:00');

abroadcitys[49]=new Array('hexj','赫尔辛基','heerxinji','helsinki','2','','新地区','','',847,1,'+02:00');

abroadcitys[50]=new Array('asb','埃斯波','aisibo','espoo','1','','新地区','','',848,1,'+02:00');

abroadcitys[51]=new Array('ml','默伦','molun','mullen','2','','法兰西岛','','',857,1,'+01:00');

abroadcitys[52]=new Array('nte','楠泰尔','nantaier','nantaire','5','','法兰西岛','','',860,1,'+01:00');

abroadcitys[53]=new Array('klty','克雷泰伊','keleitaiyi','cretay','1','','法兰西岛','','',862,1,'+01:00');

abroadcitys[54]=new Array('le','里尔','lier','lille','1','','北部-加莱海峡-皮卡第','','',878,1,'+01:00');

abroadcitys[55]=new Array('blw','布卢瓦','buluwa','blois','1','','中央-卢瓦尔谷','','',890,1,'+01:00');

abroadcitys[56]=new Array('ar','阿让','arang','agen','1','','阿基坦-利穆赞-普瓦图-夏朗德','','',920,1,'+01:00');

abroadcitys[57]=new Array('la','里昂','liang','lyon','1','','奥弗涅-罗讷-阿尔卑斯','','',940,1,'+01:00');

abroadcitys[58]=new Array('anx','阿讷西','anaxi','annexi','1','','奥弗涅-罗讷-阿尔卑斯','','',944,1,'+01:00');

abroadcitys[59]=new Array('awnw','阿维尼翁','aweiniweng','avignon','1','','普罗旺斯-阿尔卑斯-蓝色海岸','','',955,1,'+01:00');
...
abroadcitys[62]=new Array('flkf','法兰克福','falankefu','frankfurt','10','','黑森','','',978,1,'+01:00');

abroadcitys[63]=new Array('xbe','下拜恩','xiabaien','lowerbyrne','1','','拜恩（巴伐利亚）','','',990,1,'+01:00');

abroadcitys[64]=new Array('bdps','布达佩斯','budapeisi','budapest','7','','布达佩斯','','',1067,1,'+01:00');

abroadcitys[65]=new Array('yjd','雅加达','yajiada','jakarta','190','','大雅加达首都特区','','',1124,1,'+07:00');

abroadcitys[66]=new Array('wl','万隆','wanlong','bandung','62','','西爪哇省','','',1126,1,'+07:00');

abroadcitys[67]=new Array('ss','泗水','sishui','shuishui','20','','东爪哇省','','',1127,1,'+07:00');

abroadcitys[68]=new Array('rr','日惹','rire','yogyas','43','','日惹特区','','',1128,1,'+07:00');

abroadcitys[69]=new Array('dbl','都柏林','erbailin','dublin','1','','伦斯特省','','',1133,1,'+00:00');

abroadcitys[70]=new Array('ylsl','耶路撒冷','yelusaleng','jerusalem','1','','耶路撒冷区','','',1141,1,'+02:00');

abroadcitys[71]=new Array('bs','比萨','bisa','pisa','1','','托斯卡纳','','',1177,1,'+01:00');

abroadcitys[72]=new Array('hb','横滨','hengbin','yokohama','27','shennaichuan','神奈川','','',1192,1,'+09:00');

abroadcitys[73]=new Array('sh','神戸','shenhu','kobe','295','bingku','兵库','','',1195,1,'+09:00');

abroadcitys[74]=new Array('cq','川崎','chuanqi','kawasaki','1','shennaichuan','神奈川','','',1198,1,'+09:00');

abroadcitys[75]=new Array('qy','埼玉','qiyu','saitama','16','qiyu','埼玉','','',1199,1,'+09:00');

abroadcitys[76]=new Array('gd','广岛','guangdao','hiroshima','15','guangdao','广岛','','',1200,1,'+09:00');

abroadcitys[77]=new Array('xt','仙台','xiantai','sendai','17','gongcheng','宫城','','',1201,1,'+09:00');

abroadcitys[78]=new Array('qy','千叶','qianye','chiba','30','qianye','千叶','','',1203,1,'+09:00');

abroadcitys[79]=new Array('j','堺','jie','sakai','4','daban','大阪','','',1204,1,'+09:00');

abroadcitys[80]=new Array('jg','静冈','jinggang','shizuoka','5','jinggang','静冈','','',1207,1,'+09:00');

abroadcitys[81]=new Array('xb','熊本','xiongben','kumamoto','2','xiongben','熊本','','',1210,1,'+09:00');

abroadcitys[82]=new Array('cq','船桥','chuanqiao','funabashi','1','qianye','千叶','','',1212,1,'+09:00');

abroadcitys[83]=new Array('bwz','八王子','bawangzi','hachioji','3','dongjing','东京','','',1213,1,'+09:00');

abroadcitys[84]=new Array('jl','姫路','jilu','himeji','1','bingku','兵库','','',1214,1,'+09:00');

abroadcitys[85]=new Array('ddb','东大阪','dongdaban','higashiosaka','4','daban','大阪','','',1216,1,'+09:00');

abroadcitys[86]=new Array('nl','奈良','nara','nara','111','nailiang','奈良','','',1217,1,'+09:00');

abroadcitys[87]=new Array('jb','金边','jinbian','phnompenh','17','','金边市','','',1232,1,'+07:00');

abroadcitys[88]=new Array('xl','暹粒','xianli','siemreap','40','','暹粒省','','',1237,1,'+07:00');

abroadcitys[89]=new Array('xhnk','西哈努克','xihanuke','sihanouk','1','','西哈努克省','','',1238,1,'+07:00');
...
abroadcitys[102]=new Array('bc','槟城','bincheng','penang','103','','槟榔屿','','',1496,1,'+08:00');

abroadcitys[103]=new Array('mlj','马六甲','maliujia','malacca','142','','马六甲','','',1527,1,'+08:00');

abroadcitys[104]=new Array('ylyy','亚罗牙也','yaluoyaye','arroyoalso','1','','马六甲','','',1528,1,'+08:00');

abroadcitys[105]=new Array('yb','怡保','yibao','ipoh','42','','霹雳','','',1550,1,'+08:00');

abroadcitys[106]=new Array('fsg','丰盛港','fengshenggang','mercedesport','1','','柔佛','','',1552,1,'+08:00');

abroadcitys[107]=new Array('xs','新山','xinshan','johor','80','','柔佛','','',1558,1,'+08:00');
...
abroadcitys[110]=new Array('xbn','仙本那','xianbenna','sakamoto','28','','沙巴','','',1588,1,'+08:00');
...
abroadcitys[114]=new Array('xb','雪邦','xuebang','spontan','4','','雪兰莪','','',1607,1,'+08:00');
...
abroadcitys[117]=new Array('ksblk','卡萨布兰卡','kasabulanka','casablanca','6','','卡萨布兰卡','','',1697,1,'+00:00');
...
abroadcitys[124]=new Array('lm','利马','lima','lima','1','','利马','','',1795,1,'-05:00');

abroadcitys[125]=new Array('dgs','迪戈斯','digesi','digos','56','dawoqu','达沃区','','',1798,1,'+08:00');

abroadcitys[126]=new Array('hs','华沙','huasha','warsaw','2','','马佐夫舍','','',1822,1,'+01:00');

abroadcitys[127]=new Array('lsb','里斯本','lisiben','lisbon','6','','大里斯本','','',1871,1,'+00:00');
...
abroadcitys[135]=new Array('klp','科伦坡','kelunpo','colombo','4','','科伦坡县','','',2069,1,'+05:30');

abroadcitys[136]=new Array('ngb','尼甘布','niganbu','negambo','3','','加姆珀哈县','','',2075,1,'+05:30');

abroadcitys[137]=new Array('kt','康提','kangti','kandy','12','','康提县','','',2076,1,'+05:30');
...
abroadcitys[157]=new Array('txs','檀香山','tanxiangshan','honolulu','11','','夏威夷','','',2498,1,'-10:00');

abroadcitys[158]=new Array('ytld','亚特兰大','yatelanda','atlanta','1','','佐治亚','','',2550,1,'-05:00');

abroadcitys[159]=new Array('hn','河内','henei','hanoi','67','','河内市','','',2582,1,'+07:00');

abroadcitys[160]=new Array('hzm','胡志明','huzhiming','hochiminh','341','','胡志明市','','',2583,1,'+07:00');
...
abroadcitys[163]=new Array('hsadlsqd','荷属安的列斯群岛','heshuandeliesiqundao','netherlandsantilles','1','','荷属安的列斯群岛','','',2609,1,'-04:00');

abroadcitys[164]=new Array('dke','达喀尔','dakaer','dakar','1','','达喀尔','','',2613,1,'+00:00');

abroadcitys[165]=new Array('kpd','开普敦','kaipudun','capetown','1','','开普敦','','',2616,1,'+02:00');

abroadcitys[166]=new Array('qzy','泉佐野','quanzuoye','izumisano','4','daban','大阪','','',2630,1,'+09:00');

abroadcitys[167]=new Array('xjj','小金井','xiaojinjing','koganei','1','dongjing','东京','','',2677,1,'+09:00');

abroadcitys[168]=new Array('mataram','马塔兰','mataram','mataram','2','nusaenggarabarat','西努沙登加拉','','',2714,1,'+08:00');

abroadcitys[169]=new Array('hg','函馆','hanguan','hakodate','11','beihaidao','北海道','','',2715,1,'+09:00');

abroadcitys[170]=new Array('saipan','塞班岛','saipan','saipan','33','northernmariana','北马里亚纳','','',2716,1,'+10:00');

abroadcitys[171]=new Array('pasai','帕赛','pasai','pasay','6','maniladaduhui','马尼拉大都会','','',2719,1,'+08:00');

abroadcitys[172]=new Array('maynila','马尼拉','maynila','maynila','55','maniladaduhui','马尼拉大都会','','',2720,1,'+08:00');

abroadcitys[173]=new Array('makadi','马卡蒂','makadi','makati','4','maniladaduhui','马尼拉大都会','','',2723,1,'+08:00');

abroadcitys[174]=new Array('mandaluyon','曼达卢永','mandaluyong','mandaluyong','4','maniladaduhui','马尼拉大都会','','',2725,1,'+08:00');

abroadcitys[175]=new Array('paxige','帕西格','paxige','pasig','2','maniladaduhui','马尼拉大都会','','',2730,1,'+08:00');

abroadcitys[176]=new Array('tajige','塔吉格','tajige','tajig','1','maniladaduhui','马尼拉大都会','','',2733,1,'+08:00');

abroadcitys[177]=new Array('bashu','巴蜀','bashu','bayu','1','prachuap','班武里府','','',2735,1,'+7:00');

abroadcitys[178]=new Array('huaxin','华欣','huaxin','huaxin','810','prachuap','班武里府','','',2741,1,'+7:00');

abroadcitys[179]=new Array('beilan','北榄','beilan','northernlam','4','beilan','北榄','','',2744,1,'+7:00');

abroadcitys[180]=new Array('baixian','拜县','baixian','paicounty','118','yefengsong','夜丰颂','','',2745,1,'+7:00');

abroadcitys[181]=new Array('jiami','甲米','jiami','krabi','955','jiami','甲米','','',2746,1,'+7:00');

abroadcitys[182]=new Array('qinglaishi','清莱','qinglaishi','chiangrai','1','qinglai','清莱','','',2747,1,'+7:00');

abroadcitys[183]=new Array('gs','高松','gaosong','takamatsu','1','xiangchuan','香川','','',2748,1,'+09:00');

abroadcitys[184]=new Array('nb','那霸','naba','naha','20','chongsheng','冲绳','','',2749,1,'+09:00');

abroadcitys[185]=new Array('yyw','宜野湾','yiyewan','ginowan','1','chongsheng','冲绳','','',2750,1,'+09:00');

abroadcitys[186]=new Array('sy','石垣','shiyuan','ishigaki','1','chongsheng','冲绳','','',2751,1,'+09:00');

abroadcitys[187]=new Array('pts','浦添','putianshi','urasoe','1','chongsheng','冲绳','','',2752,1,'+09:00');

abroadcitys[188]=new Array('mm','糸满','miman','itoman','2','chongsheng','冲绳','','',2754,1,'+09:00');

abroadcitys[189]=new Array('ylm','宇流麻','yuliuma','uruma','1','chongsheng','冲绳','','',2756,1,'+09:00');

abroadcitys[190]=new Array('nc','南城','nancheng','nanjo','1','chongsheng','冲绳','','',2758,1,'+09:00');

abroadcitys[191]=new Array('gt','国头','guotou','kunigami','2','chongsheng','冲绳','','',2759,1,'+09:00');

abroadcitys[192]=new Array('boracay','长滩岛','boracay','boracay','21','ximishayan','西米沙鄢','','',2851,1,'+08:00');

abroadcitys[193]=new Array('coquitlam','高贵林','coquitlam','coquitlam','6','','不列颠哥伦比亚省','','',2743,1,'-08:00');

abroadcitys[194]=new Array('xz','小樽','xiaozun','otaru','79','beihaidao','北海道','','',2765,1,'+9:00');

abroadcitys[195]=new Array('jb','江别','jiangbie','ebetsu','2','beihaidao','北海道','','',2777,1,'+9:00');

abroadcitys[196]=new Array('fly','富良野','fuliangye','furano','1','beihaidao','北海道','','',2789,1,'+9:00');

abroadcitys[197]=new Array('kaerjiali','卡尔加里','kaerjiali','calgary','1','','艾伯塔省','','',2798,1,'-7:00');

abroadcitys[198]=new Array('vancouver','温哥华','vancouver','vancouver','17','','不列颠哥伦比亚省','','',2801,1,'-8:00');

abroadcitys[199]=new Array('westvancou','西温','westvancouver','westwen','3','','不列颠哥伦比亚省','','',2802,1,'-8:00');

abroadcitys[200]=new Array('richmond','列治文','richmond','richmondcan','22','','不列颠哥伦比亚省','','',2803,1,'-8:00');

abroadcitys[201]=new Array('burnaby','本那比','burnaby','benabi','10','','不列颠哥伦比亚省','','',2804,1,'-8:00');

abroadcitys[202]=new Array('surrey','素里','surrey','suri','5','','不列颠哥伦比亚省','','',2805,1,'-8:00');

abroadcitys[203]=new Array('whiterock','白石','whiterock','whitestone','1','','不列颠哥伦比亚省','','',2806,1,'-8:00');

abroadcitys[204]=new Array('newwestmin','新威斯敏斯特','newwestminster','newwestminster','2','','不列颠哥伦比亚省','','',2808,1,'-8:00');

abroadcitys[205]=new Array('szh','山中湖','shanzhonghu','yamanakako','1','shanli','山梨','','',2831,1,'+09:00');

abroadcitys[206]=new Array('fshkh','富士河口湖','fushihekouhu','fujikawaguchiko','22','shanli','山梨','','',2833,1,'+09:00');

abroadcitys[207]=new Array('queenstown','皇后镇','queenstown','queenstown','1','','奥塔戈','','',2848,1,'+12:00');

abroadcitys[208]=new Array('istanbul','伊斯坦布尔','istanbul','istanbul','7','istanbul','伊斯坦布尔','','',2849,1,'+2:00');

abroadcitys[209]=new Array('fuguodao','富国岛','fuguodao','fuguodao','1','jianjiang','坚江','','',2850,1,'+7:00');

abroadcitys[210]=new Array('zbxj','足柄下','zubingxia','ashigarashimo','50','shennaichuan','神奈川','','',2854,1,'+09:00');

abroadcitys[211]=new Array('mtle','蒙特利尔','mengtelier','montreal','10','','魁北克省','','',2855,1,'-04:00');

abroadcitys[212]=new Array('wotaihua','渥太华','wth','ottawa','4','','安大略省','','',2856,1,'-06:00');

abroadcitys[213]=new Array('nyjlpbc','尼亚加拉瀑布城','niyajialapubucheng','niagarafalls','2','','安大略省','','',2857,1,'-06:00');

abroadcitys[214]=new Array('lkw','兰卡威','lankawei','pulaulangkawi','1','','吉打','','',2858,1,'+08:00');

abroadcitys[215]=new Array('stln','圣托里尼','shengtuolini','santorini','3','','南爱琴大区','','',2875,1,'+02:00');

abroadcitys[216]=new Array('yintelaken','因特拉肯','yintelaken','interlaken','20','','伯尔尼','','',2876,1,'+01:00');

abroadcitys[217]=new Array('bkl','博卡拉','bokala','pokhara','7','gandaji','甘达基区','','',2879,1,'+05:45');

abroadcitys[218]=new Array('sw','宿务','suwu','cebu','1','zhongmishayan','中米沙鄢','','',2881,1,'+08:00');

abroadcitys[219]=new Array('bhd','薄荷岛','bohedao','boholisland','6','zhongmishayan','中米沙鄢','','',2882,1,'+08:00');

abroadcitys[220]=new Array('mt','虻田','mengtian','abuta','1','beihaidao','北海道','','',2886,1,'+09:00');

abroadcitys[221]=new Array('jz','金泽','jinze','kanazawa','5','shichuan','石川','','',2890,1,'+09:00');

abroadcitys[222]=new Array('rg','日光','riguang','nikko','2','limu','枥木','','',2891,1,'+09:00');

abroadcitys[223]=new Array('lc','镰仓','liancang','kamakura','3','shennaichuan','神奈川','','',2896,1,'+9:00');

abroadcitys[224]=new Array('luotuoluwa','罗托鲁瓦','luotuoluwashi','rotorua','1','','普伦蒂湾','','',2899,1,'+12:00');

abroadcitys[225]=new Array('gechangxia','阁昌','gechangxian','gechangxian','2','dalefu','达叻','','',2902,1,'+07:00');

abroadcitys[226]=new Array('jujun','橘郡','jujun','jujun','6','','加利福尼亚','','',2903,1,'-08:00');

abroadcitys[227]=new Array('sy','松原','sonyuan','matsubara','1','daban','大阪','','',2917,1,'+09:00');
    ...
    timer = setTimeout(function() {
        if (DetailGMap.GMap !== undefined) {
            ...
            var marker = new google.maps.Marker({
                ...
                map: DetailGMap.GMap,
                icon: '/images/icon_logo_detail_map.png'
            });
...
springFestivalPop(); 
    ...
    //首页轮播
    //首页推荐
    $('.rooms_show_ul').on('mouseover','li',function () {
        var userId = $('#loginUserId').val() || '';
        var tag = false;
        $(this).children().each(function () {
            if($(this).hasClass('hover-wrap')){
                $(this).show();
                tag = true;
                return;
            }
        ...
        if(!tag){
            var luId = $(this).children('.luId').val() || '';
            var cityId = $(this).children('.cityId').val() || '';
            var qrCodeUrl = '';
            var qrCodeTip = '';
            var html = '';
            var that = this;
            $.ajax({
                type: "get",
                url: XZWebUrlWriter.getQrCode(luId, cityId, userId),
                success: function(res) {
                    var data = eval("("+res+")");
                    if(data.status == 1)
                    {
                        qrCodeUrl = data.sucmsg.qrCodeUrl;
                        qrCodeTip = data.sucmsg.qrCodeTip;
                        if(qrCodeUrl && qrCodeTip){
                            html = '<div class="hover-wrap"><div class="code-wrap"><p>' + qrCodeTip + '</p><img src="' + qrCodeUrl + '" alt=""></div></div>';
                            $(that).append(html);
                        }
                    }
    ...
    $('.detail_code_wrap > i').on('click',function () {
        $(this).parent().hide();
    });
    $('.rooms_show_ul,.list_code').on('mouseout','li',function () {
        $('.hover-wrap').hide();
    });
    $('.rooms_show_ul').on('click','li', function (e) {
        var href = $(this).children('.room_hover').attr('href');
        window.open(href);
    });
    //搜索结果页
    $('.list_code').on('mouseover', 'li' ,function () {
        var userId = $('#loginUserId').val() || '';
        var tag = false;
        $(this).children().each(function () {
            if($(this).hasClass('hover-wrap')){
        ...
        if(!tag){
            var luId = $(this).attr('lodgeunitid').split('_')[1] || '';
            var cityId = '';
            var qrCodeUrl = '';
            var qrCodeTip = '';
            var html = '';
    ...
    $('.list_code').on('click','li', function (e) {
        var href = $(this).children('.resule_img_a').attr('href');
        window.open(href);
    });